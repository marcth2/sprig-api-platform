...
4. Use `app/HealthCheck/Actions/CheckServiceHealth.php` as the canonical style reference:
   ...
   - Use `ref:` to reference schemas defined by `#[OA\Schema]` on the owning DTO class (see `app/Shared/CLAUDE.md`) — do not create standalone schema-holder classes in `app/Shared/`.
