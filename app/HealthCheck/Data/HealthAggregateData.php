...
class HealthAggregateData extends Data
{
    public function __construct(
        ...
        #[OA\Property(
            property: 'services',
            type: 'array',
            description: 'Health status of each registered service.',
        ...
        #[OA\Property(
            property: 'healthy',
            type: 'boolean',
            description: '`true` when every service reports `ok`; `false` when any service is `degraded` or `down`.',
            example: true,
        )]
        ...
        #[OA\Property(
            ...
            type: 'string',
            format: 'date-time',
            description: 'ISO 8601 timestamp (UTC) of when the check was performed.',
            example: '2026-06-26T12:00:00+00:00',
        )]
