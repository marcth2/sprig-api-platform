...
#[OA\Info(
    ...
    description: 'Laravel 13 platform serving as a team starter template and home for migrated services. All endpoints require a Sanctum Bearer token (Authorization: Bearer <token>). API version is negotiated via the X-API-Version request header (current: v0).',
)]
