...
#[OA\Info(
    ...
    description: 'Laravel 13 platform serving as a team starter template and home for migrated services.'
...
#[OA\Tag(
    name: 'HealthCheck',
    description: 'Service readiness checks for deployment pipelines, monitoring systems, and local debugging.'
